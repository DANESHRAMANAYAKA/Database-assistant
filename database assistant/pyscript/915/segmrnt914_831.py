...
def printrelationships(lines):
    ...
    patten1 = ['NN', 'VB', 'NN']#1to1
    patten2 = ['NNS', 'VB', 'NN']#M to1
    patten3 = ['NN', 'VB', 'NNS']#1toM
    patten4 = ['NNS', 'VB', 'NNS'] #MtoM

    patten5 = ['NN', 'VB', 'DT', 'NN']  # 1to1
    patten6 = ['NNS', 'VB', 'DT', 'NN']  # M to1
    patten7 = ['NN', 'VB', 'DT', 'NNS']  # 1toM
    patten8 = ['NNS', 'VB', 'DT', 'NNS']  # MtoM

    patten9 = ['NN', 'VB', 'IN', 'DT', 'NN']  # 1to1
    patten10 = ['NNS', 'VB', 'IN', 'DT', 'NN']  # M to1
    patten11= ['NN', 'VB', 'IN', 'DT', 'NNS']  # 1toM
    patten12 = ['NNS', 'VP', 'IN', 'DT', 'NNS']  # MtoM

    patten13 = ['NN', 'VB', ' IN', 'NN']  # 1to1
    patten14 = ['NNS', 'VB', 'IN', 'NN']  # M to1
    patten15= ['NN', 'VB', 'IN', 'NNS']  # 1toM
    patten16 = ['NNS', 'VB', 'IN', 'NNS']  # MtoM

    rpatten1=['NN', 'NN', 'IN', 'NN'] # 1to1

    for word, pos in nltk.pos_tag(nltk.word_tokenize(str(localline))):
        print("start check logic")
        if (tags == patten1 or tags == patten5 or tags == patten9 or tags == patten13 or tags == rpatten1):
                print("1to1")
                cadanaliry = "1to1"
        if(tags == patten13):
            print("1to1")
...
##########################################################################################################################################################################
    try:
        ...
        if( cadanaliry == "MtoM"):
                    ...
                    if (pos == 'NN' or pos == 'NNP' or pos == 'NNS' or pos == 'NNPS'):
                        ...
                        if (pos == 'NNS' or pos == 'NNPS'):
                            ...
                            if (count == 0):
                                ...
                                print('cadanalit222222222222222222222222222222222222222------------------------>' + "1")
            ...
            file.write("\n")
            file.write("r" + "[" + tempnoun1 + " " + filterrelationship + " " + tempnoun2 + "-" + kadanality1 + " " + "to" + " " + kadanality2 + " " + "]")
            file.write("\n")
            print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
                ...
                for word, pos in nltk.pos_tag(nltk.word_tokenize(str(sentence))):
                    ...
                    if (pos == 'NN' or pos == 'NNP' or pos == 'NNS' or pos == 'NNPS'):
                        ...
                        if (pos == 'NNS' or pos == 'NNPS'):
                            ...
                            print('cadanalit111111111111111111111111111111111111111------------------------>' + "M")
                            filternoun1 = word
                            kadanality1 = '*'
