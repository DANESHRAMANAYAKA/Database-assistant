...
def printrelationships(lines):
    ...
    try:
      ...
      #  lines = token
            ...
            for word, pos in nltk.pos_tag(nltk.word_tokenize(str(sentence))):
                ...
                if (pos == 'NN' or pos == 'NNP' or pos == 'NNS' or pos == 'NNPS'):
                    ...
                    if(pos == 'NN' or pos == 'NNP'):
                        if(count == 0 ):
                            print('Entites0000000000000000000000000000000000000000------------------------>' + word)
                            print('cadanalit0000000000000000000000000000000000000000------------------------>' + "1")
                            filternoun1=word
                            kadanality1='1'
                            count=count+1
                            print(count)
                    ...
                    if(pos == 'NNS' or pos == 'NNPS'):
                            ...
                            print('Entites22111111111111111111------------------------>' + word)
                            print('cadanalit221111111111111111------------------------>' + "*")
        ...
        if (tag == "1to1"):
            file.write("\n")
            file.write("r" + "[" + filternoun1 + " " + filternoun2 + " " + filternoun3 + "-" + kadanality1 + " " + "to" + " " + kadanality2 + " " + "]")
            file.write("\n")
