...
def readrelationshipfile():
    ...
    relationship1.append(entity1)
    relationship1.append(';')
    relationship1.append(k11)
    relationship1.append(';')
    relationship1.append(k22)
    relationship1.append(';')
    relationship1.append('R_')
    relationship1.append(globalerelationship)
    relationship1.append(';')
    relationship1.append('.')
    relationship1.append(entity2)
    relationship1.append(';')
    '''
...
def readoutput1():
    ...
    f1 = open("D:\\sliit\\4th year\\CDAP\\proj_workspace\\developsystem\\database assistant\\database assistant\\bin\\Debug\\output1.txt",'r+')
    ...
    for words1 in f1.read().split('\n'):
        ...
        if(flag == 't' and flag2 =='t'):
          count = count + 1
          print(l)
       
        if(key == l and count == 1):
            flag='t'
        ...
        if(flag == 't' and flag2!='t' ):
            ...
            tempva1=empval.split(']')
            #tempva2=tempval.split(']')[0]
            #print(l)
     '''
    print(output1)
...
def mapgihan():
    ...
    f = open(
        "D:\\sliit\\4th year\\CDAP\\proj_workspace\\developsystem\\database assistant\\database assistant\\bin\\Debug\\mapping_relationship.txt",
        'r+')
    f1 = open(
        "D:\\sliit\\4th year\\CDAP\\proj_workspace\\developsystem\\database assistant\\database assistant\\bin\\Debug\\output1.txt",
        'r+')
...
def filteroutput1(keyword):
    ...
    #print('final------------->' + str(output1[count1-1:count2]))
    temp=output1[count1-1:count2]
